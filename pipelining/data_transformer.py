...
def transform(df, *args, **kwargs):
    ...
    datetime_dim['pcik_year']  = datetime_dim['tpep_pickup_datetime'].dt.year
    ...
    datetime_dim = datetime_dim[['datetime_id', 'tpep_pickup_datetime', 'pick_hour',
                                'pick_day', 'pick_month', 'pcik_year', 
                                'pick_weekday', 'tpep_dropoff_datetime', 
                                'drop_hour','drop_day', 'drop_month', 'drop_year', 
                                'drop_weekday']]
    ...
    # Rate Code
    # the info here was obtained via the data dictionary
    rate_code_type = {
        1: "Standard Rate",
        2: "JFK",
        3: "Newark",
